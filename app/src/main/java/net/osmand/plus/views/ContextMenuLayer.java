...
public class ContextMenuLayer extends OsmandMapLayer {
	...
	private TextView textView, tvServiceAdrs;
	...
	public void initLayer(OsmandMapTileView view) {
		...
		tvServiceAdrs = new TextView(view.getContext());
		LayoutParams lpSA = new LayoutParams(LayoutParams.WRAP_CONTENT, (int) (24 * scaleCoefficient));
		tvServiceAdrs.setLayoutParams(lpSA);
		tvServiceAdrs.setTextSize(15);
		tvServiceAdrs.setTextColor(Color.BLACK);
		tvServiceAdrs.setMinLines(1);
		tvServiceAdrs.setGravity(Gravity.LEFT);
	...
	private void layoutText() {
		...
		int wSA = BASE_TEXT_SIZE;
		int hSA = (int) ((tvServiceAdrs.getPaint().getTextSize() + 4) * tvServiceAdrs.getLineCount());
		tvServiceAdrs.layout(0, 0, wSA, hSA);
	...
	public void setLocation(LatLon loc, String description) {
		...
		if (latLon != null) {
			if (description == null || description.length() == 0) {
				description = view.getContext().getString(R.string.point_on_map, latLon.getLatitude(), latLon.getLongitude());
			}
	...
	public boolean onLongPressEvent(PointF point) {
		...
		// if (!selectedObjects.isEmpty()) {
		// LatLon l =
		// selectedContextProvider.getObjectLocation(selectedObjects.get(0));
		// if (l != null) {
		// latLon = l;
		// }
		// }
