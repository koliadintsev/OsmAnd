...
public class TTSCommandPlayerImpl extends AbstractPrologCommandPlayer {
	...
	protected TTSCommandPlayerImpl(Activity ctx, OsmandSettings settings, String voiceProvider) throws CommandPlayerException {
					...
					if (status != TextToSpeech.SUCCESS) {
						...
						case TextToSpeech.LANG_MISSING_DATA:
							if (isSettingsActivity(act)) {
								Builder builder = createAlertDialog(R.string.tts_missing_language_data_title, R.string.tts_missing_language_data, new IntentStarter(act,
										TextToSpeech.Engine.ACTION_INSTALL_TTS_DATA), act);
								builder.show();
							}
							break;
						...
						case TextToSpeech.LANG_NOT_SUPPORTED:
							...
							//this if condition
							if (isSettingsActivity(act)) {
								Builder builder = createAlertDialog(R.string.tts_language_not_supported_title, R.string.tts_language_not_supported,
										new IntentStarter(act, Intent.ACTION_VIEW, Uri.parse("market://search?q=text to speech engine")), act);
								builder.show();
							}
							break;
						}
