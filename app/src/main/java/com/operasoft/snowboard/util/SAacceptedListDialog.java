...
public class SAacceptedListDialog {
	...
	public SAacceptedListDialog(Context context, View view, Collection<PointOfInterest> collection) {
	...
	public OnClickListener acceptedSAListener = new OnClickListener() {
